...
fun CatalogRowSection(
    ...
    thumbnailPreviewUrls: Map<String, String> = emptyMap(),
    thumbnailPreviewAudioUrls: Map<String, String> = emptyMap(),
        ...
        LazyRow(
            ...
            itemsIndexed(
                ...
                ContentCard(
                    ...
                    thumbnailVideoPreviewEnabled = thumbnailVideoPreviewEnabled,
                    thumbnailPreviewUrl = thumbnailPreviewUrls[item.id],
                    thumbnailPreviewMuted = thumbnailPreviewMuted,
                    thumbnailPreviewDelaySeconds = thumbnailPreviewDelaySeconds,
